...
export default class ChangeCaseMenuView {
  ...
  constructor(serializedState) {
    ...
    atom.config.observe('atom-change-case-menu.showBasicCases', (newValue) => {
      this.setup();
    });
    atom.config.observe('atom-change-case-menu.showAdvancedCases', (newValue) => {
      this.setup();
    });
    atom.config.observe('atom-change-case-menu.showProgrammingCases', (newValue) => {
      this.setup();
    });
    atom.config.observe('atom-change-case-menu.showCustomCases', (newValue) => {
      this.setup();
    });
  ...
  // Hide panel when selection is done or cancelled
  end() {
  ...
  predictive(text) {
    if(text == changeCase.lowerCase(text)) {
      return changeCase.sentenceCase(text);
    }else if(text == changeCase.sentenceCase(text)) {
      return changeCase.upperCase(text);
    }else {
