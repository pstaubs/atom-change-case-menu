...
export default class ChangeCaseMenuView {
  ...
  constructor(serializedState) {
    ...
    atom.config.onDidChange('atom-change-case-menu.showPredictiveCase', (newValue) => {
      this.setup();
    });
    atom.config.onDidChange('atom-change-case-menu.showBasicCases', (newValue) => {
      this.setup();
    });
    atom.config.onDidChange('atom-change-case-menu.showAdvancedCases', (newValue) => {
      this.setup();
    });
    atom.config.onDidChange('atom-change-case-menu.showProgrammingCases', (newValue) => {
      this.setup();
    });
    atom.config.onDidChange('atom-change-case-menu.showCustomCases', (newValue) => {
      this.setup();
    });
