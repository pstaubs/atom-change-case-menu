...
export default {
  ...
  config: {
    showPredictiveCase: {
      ...
      description: 'This operation will generally cycle through: Sentence case, UPPERCASE, and lowercase. This operation can also be launched directly with the command "change-case-menu:cycle" which defaults to the hotkey Shift+F3.',
      default: true,
      order: 1
    },
    showBasicCases: {
    ...
    defineCustomCases: {
      ...
      description: 'Valid choises: `camelCase`, `constantCase`, `dotCase`, `headerCase`, `lowerCase`, `lowerCaseFirst`, `paramCase`, `pascalCase`, `pathCase`, `sentenceCase`, `snakeCase`, `swapCase`, `titleCase`, `upperCase`, and `upperCaseFirst`.',
      default: '',
      order:6
    }
  },
